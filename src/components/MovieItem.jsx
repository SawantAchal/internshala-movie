...
const MovieItem = ({movie}) => {
  ...
  return (
    <div className="flex items-center justify-center flex-col cursor-pointer border border-white gap-6 text-center p-3 rounded-lg mt-96 md:mt-16" onClick={handleClick}>
